...
- **Panel de administración (`/admin`) sin gestión del catálogo de marcas/modelos**: desde la Fase 59 ya existe un panel con roles (Usuarios, Identidad, Publicaciones, Suscripciones y Pagos, Destacados, Auditoría — ver `ARCHITECTURE.md` §7.2), pero agregar nuevas marcas/modelos sigue requiriendo una modificación manual de los datos semilla (`prisma/seed.ts`) — no es uno de los módulos actuales.
